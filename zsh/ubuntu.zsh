...
alias update="sudo apt update -y && sudo apt upgrade -y && sudo apt autoremove -y && sudo apt clean && rbenv update"
alias upgrade="update && sudo apt full-upgrade -y && do-release-upgrade -c"
