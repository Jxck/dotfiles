...
_mise() {
  ...
  if ( [[ -z "${_usage_spec_mise_2026_1_1:-}" ]] || _cache_invalid _usage_spec_mise_2026_1_1 ) \
      && ! _retrieve_cache _usage_spec_mise_2026_1_1;
  then
    spec="$(mise usage)"
    _store_cache _usage_spec_mise_2026_1_1 spec
  fi
